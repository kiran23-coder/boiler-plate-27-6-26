...
export function Domains() {
  ...
  return (
    ...
    <UniversalCRUDLayout
      ...
      description="Manage vanity URLs and SSL certificates."
      toolbarActions={
        ...
        <table className="w-full whitespace-nowrap text-left text-sm">
          <thead className="bg-slate-50 dark:bg-slate-900/50">
            <tr>
              ...
              <th className="px-6 py-4 font-semibold text-slate-900 dark:text-slate-200">SSL Status</th>
    ...
    >
      ...
      <Drawer isOpen={isDrawerOpen} onClose={() => setIsDrawerOpen(false)} title="Add/Edit Custom Domains">
