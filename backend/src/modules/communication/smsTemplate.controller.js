...
exports.getTemplates = async (req, res) => {
  try {
    const templates = await smsTemplateService.getTemplates(req.user.tenantId);
...
exports.createTemplate = async (req, res) => {
  try {
    const template = await smsTemplateService.createTemplate(req.user.tenantId, req.body);
...
exports.updateTemplate = async (req, res) => {
  try {
    const { id } = req.params;
    const template = await smsTemplateService.updateTemplate(req.user.tenantId, id, req.body);
...
exports.deleteTemplate = async (req, res) => {
  try {
    const { id } = req.params;
    await smsTemplateService.deleteTemplate(req.user.tenantId, id);
